...
@section('titulo', 'Novo Produto — Sistema de Produtos')

@section('conteudo')
<div class="page-header">
    <h1><i class="bi bi-plus-circle-fill me-2" style="color:#6366f1"></i>Novo Produto</h1>
...
<div class="card-custom p-4" style="max-width:680px">
    <form method="POST"
        ...
        <div class="mb-4">
            ...
            <div class="text-muted small mt-1">JPG, PNG, GIF — máx. 2MB</div>
        </div>

        <div class="d-flex gap-3">
            <button type="submit" class="btn-primario" id="btn-salvar-produto">
                <i class="bi bi-check-lg"></i> Salvar Produto
            </button>
            <a href="{{ route('produtos.listar') }}" class="btn-secundario" id="btn-cancelar-produto">
